...
<div id='rick'>
      <Atropos style={{height:"600px"}} alwaysActive shadow={false} highlight={false}  rotateXMax={180} rotateYMax={25}> <img alt='What are you looking at?' src={require('./assets/images/rickflip.png')}  style={{marginTop:"8vh",marginLeft:"5.5vw",height:"550px",width:"600px",}} ></img>
    </Atropos>
    </div>
    <img id="threed" src='https://i.postimg.cc/K8592t7j/transparent3d.png' style={{color:"white",marginTop:"20vh",marginLeft:"-3vw",height:"50px",width:"50px",objectFit:"cover"}} ></img>
